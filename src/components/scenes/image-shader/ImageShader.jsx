...
export default function Model({ activeMenu }) {
  ...
  // Load all textures at the top level using useTexture
  const texturePaths = projects.map((project) => project.src); // Extract paths
  const textures = useTexture(texturePaths);

  // Ensure the textures array has at least one texture
